		...
		<div class="grid-container py-2">
			...
			<div class="grid-item d-none d-lg-block mt-1 idiomas">
				...
				<form method="post" action="<?php echo "http://".$_SERVER["HTTP_HOST"].$_SERVER["REQUEST_URI"];  ?>">
					...
					<input type="submit" translate="no" value="ES" class="border border-info float-left p-1 bg-white text-dark  idiomaEs px-2" style="cursor:pointer">
				...
				<form method="post" action="<?php echo "http://".$_SERVER["HTTP_HOST"].$_SERVER["REQUEST_URI"];  ?>">
					...
					<input type="submit" translate="no" value="EN" class="border border-info float-left p-1 bg-info text-white idiomaEn px-2" style="cursor:pointer">

				</form>

				<!-- https://translate.yandex.com/developers/website-widget -->
