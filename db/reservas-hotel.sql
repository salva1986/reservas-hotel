...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 24, 2019 at 02:58 AM
...
(12, 18, 4, 2, 'Volveré con mi familia', 0, '2019-09-23 23:16:47'),
(13, 19, 4, 3, 'Sin lugar a dudas, el mejor hotel de la zona', 1, '2019-09-23 23:23:42');
...
(3, 'Juan Fernando Urrego', '$2a$07$asxx54ahjppf45sd87a5auFL5K1.Cmt9ZheoVVuudOi5BCi10qWly', 'correotutorialesatualcance@gmail.com', 'vistas/img/usuarios/3/279.png', 'directo', 0, '678ec21f18a39c43b95e93de54d78a93', '2019-07-09 13:58:07'),
...
--
ALTER TABLE `usuarios`
  MODIFY `id_u` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;COMMIT;
